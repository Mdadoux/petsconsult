<form action="{{route('patients.store', Auth::user()->id)}}" method="POST" enctype="multipart/form-data">

    @csrf
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        {{-- le'url de modification de formulaire si pour une modification' --}}
        <input type="hidden" value="{{route('patients.update','test')}}" name="form-update-action"
            id="form-update-action">
        <li class="nav-item">
            <a class="nav-link active" id="modal-home-tab" data-toggle="tab" href="#modal-home" role="tab"
                aria-controls="modal-home" aria-selected="true">Infos</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" id="modal-contact-tab" data-toggle="tab" href="#contact" role="tab"
            ...
            <div class="tab-content-inner py-4">
                ...
                <div class="form-row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="discipline" name="animal-discipline"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-control" id="proprietaire" name="animal-proprietaire">
                            ...
                            <option value="{{$proprietaire->id}}">{{$proprietaire->nom}} - {{$proprietaire->prenom}}
                            </option>
                            @endforeach
                            @endif
                        </select>
