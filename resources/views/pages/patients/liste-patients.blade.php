...
<div class="container-fluid">
    ...
    <p class="mb-4">{{__("Liste de tous les patients")}}
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable-patients" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        @foreach ($patients_list as $key=> $patient)
                            ...
                            <td>
                                <div class="action-wrapper">
                                    ...
                                    <a href="#" class="btn btn-danger btn-circle btn-sm delete-btn"
                                        data-titre="{{$patient->nom}}" id="{{$patient->id}}" data-toggle="modal"
                                        data-target="#delete-modal">
                                        <i class="fas fa-trash"></i>
                                    </a>
                                    <a href="#" class="btn btn-primary btn-circle btn-sm patient-edit"
                                        data-toggle="modal" data-idpatient="{{$patient->id}}" data-target="#add-Modal">
