...
<div class="p-2 mb-3">
    ...
    <div class="page-btn-action w-50 ml-auto text-right">
        <a href="{{route('consultations.edit',['Auth::user()->id','$consultation->id'])}}"
            class="btn btn-primary btn-icon-split"><span class="icon text-white-50"> <i class="fas fa-pen-square"></i>
            </span>
            <span class="text">Modifier</span>
        </a>
        <a href="{{ route('viewer',[Auth::user()->id,$consultation->id])}}" class="btn btn-danger btn-icon-split">
    ...
    <a href="{{route('consultations.index',Auth::user()->id)}}">Retour</a>
</div>
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-profile-tab" data-toggle="tab" href="#nav-profile"
                            role="tab" aria-controls="nav-profile" aria-selected="false">Bilan</a>
                        <a class="nav-item nav-link" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab"
                            aria-controls="nav-home" aria-selected="true"> Infos</a>
                ...
                <div class="card-text">
                    <div class="row">
                        ...
                        <div class="col-5">
                            ...
                            <p>{{$consultation->animal->age}} {{intval($consultation->animal->age) > 1  ? 'ans' : 'an'}}
                            </p>
                            @else
