; (function ($, window, document, undefined) {
  ...
  $.extend(Plugin.prototype, {
    ...
    addTextbox: function (marker) {
      ...
      var $title = $('<h2 class="image-marker__text-box__title" contenteditable="true">Votre titre ici</h2>');
      ...
      var $content = $('<p class="image-marker__text-box__content" contenteditable="true">Un commentaire ici</p>');
